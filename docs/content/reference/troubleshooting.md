...
Most of these come down to network reality or how gaia serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gaia rate-limits like any public site. gaia already paces
...
Where a surface is gated, gaia reads a cookie or token you supply
...
`gaia`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gaia actually did
